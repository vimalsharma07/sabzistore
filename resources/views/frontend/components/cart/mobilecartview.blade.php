    ...
    @if (!$emptycart)
                                        ...
                                        <div
                                            ...
                                            <div class="gap-2 d-flex align-items-center justify-content-between">
                                                ...
                                                <span class="p-0 text-center border-0 shadow-none form-control box"
                                                    ...
                                                    value="{{ $item['quantity'] }}" disabled>{{ $item['quantity'] }}
                                                </span>
            ...
            <div class="p-4 bg-white border-bottom">
                ...
                <div class="container mt-5 d-none" id="customTipBox">
                    <div class="customtip-section">
                        <input type="number" class="form-control" id="customtipvalue" placeholder="Enter tip"
                            min="0">
        ...
        <div class="address-selection">
            ...
            @if ($address != '')
                ...
                <div class="p-4 mx-4 mb-4 bg-white shadow rounded-4 ">
                    <div class="mb-3 d-flex align-items-center justify-content-between">
                        <div class="gap-3 d-flex align-items-center">
                            <div><i class="fa-solid fa-location-dot text-danger h4"></i></div>
                            <div>
                                <h4 class="mb-1 fw-bold">Delivering to home</h4>
                                <p class="m-0 text-muted">{{ $address->houseno }} {{ $address->address }}</p>
                            </div>
                        </div>
                        <div>
                            <a href=""
                                class="text-decoration-none text-danger text-uppercase">change</a>
                        </div>
                    </div>
                    <div class="d-grid">
                        <a href="{{ url('/order/create') }}" class="btn btn-success btn-lg rounded-pill">Confirm & Place Order</a>
                    </div>
                </div>
            ...
            <div class="pt-5 pb-4"></div>
                ...
                <div class="p-4 fixed-bottom fixed-bottom-btn">
                    <a data-bs-toggle="modal" data-bs-target="#otpModal" aria-expanded="false"
                        class="btn btn-success btn-lg d-grid rounded-pill">
                        <div class="d-flex justify-content-between">
                            <div></div>
