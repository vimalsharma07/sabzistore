    ...
    <div class="row g-2">
       <div class="col-4">
          <div class="text-decoration-none text-white">
             <div class="bg-danger bg-gradient p-3 rounded-md text-white">
                <h5 class="fw-bold mb-1">Deals of the Day</h5>
                <p class="small m-0 text-white-50">60% OFF&nbsp;
       ...
       <div class="col-4">
          <div class="text-decoration-none text-white">
             <div class="bg-warning bg-gradient p-3 rounded-md text-white">
                <h5 class="fw-bold mb-1">Unlimited Flat Deal</h5>
                <p class="small m-0 text-white-50">Big orders&nbsp;
                   <a href="#" class="text-decoration-none text-white-50"><i class="fa-solid fa-arrow-right"></i></a>
                </p>
             </div>
          </div>
       ...
       <div class="col-4">
          <div class="text-decoration-none text-white">
             <div class="bg-success bg-gradient p-3 rounded-md text-white">
                <h5 class="fw-bold mb-1">Fastest Deliveries</h5>
                <p class="small m-0 text-white-50">See offers&nbsp;
                   <a href="#" class="text-decoration-none text-white-50"><i class="fa-solid fa-arrow-right"></i></a>
                </p>
             </div>
          </div>
